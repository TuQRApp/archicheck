...
import _celda4_funciones_PORTADO as c4  # noqa: E402
...
with open("_harness_resultado_PORTADO.json", "w", encoding="utf-8") as f:
    json.dump(datos, f, ensure_ascii=False, indent=1)
print("\nGuardado: _harness_resultado_PORTADO.json")
