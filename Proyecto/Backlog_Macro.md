...
## 7. Interfaz de carga — contexto de edificación (ambos canales), mapeo de niveles (BIM), cuadro de superficies (BIM)

Cuando se sube un plano, hoy entra directo al análisis sin ningún contexto declarado por el usuario. Agregar un paso de preguntas.

**a) Contexto de edificación — para ambos canales, BIM y PDF/CAD** (confirmado explícitamente por el usuario 2026-09-21: no es solo para BIM). El tipo de normativa aplicable depende del tipo de edificación y de la obra, sin importar si el insumo es un IFC o un PDF vectorial:

- **Tipo de construcción (obligatorio)**: casa/vivienda unifamiliar, edificio habitacional (vivienda colectiva), colegio/establecimiento educacional, oficinas, comercio, industria, salud, otro. Conecta directo con OGUC Art. 4.5.1 (establecimientos) y con los destinos que ya aparecen en los dos demos (educativo en el demo 1, comercio+oficinas en Beauchef).
...
- **Tipo de obra**: nueva / remodelación / ampliación / regularización de obra existente / otro → LGCU Art. 116 vs. 116 bis tienen requisitos distintos
